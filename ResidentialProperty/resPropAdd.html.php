...
Purpose: A PHP/HTML form for entering a new Residential Property-->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="panel"> <!--panel class from css-->
                ...
                <div id="clienterrmsg"></div>
                    ...
                    <div class="two-col"> <!--two column css styling tag-->
                        ...
                        oninput="this.setCustomValidity('')" maxlength="100"><br> <!--pattern can use any alphabet character, digit, comma or space. Warning message custom made if incorrect input detected-->
                        ...
                        <input type="text" id="location" name="location" placeholder="Notes on location"  maxlength="100"><br> <!--optional extra in case of hard to find location-->
                        ...
                        <input type="number" id="bathrooms" name="bathrooms" required pattern="^[\d]+$" min="0" max="50"
                    ...
                    <div class="col"> <!--column two of css-->
                        <label for="area">Area of house in meters squared:</label><br> <!--area of house entry-->
                        ...
                        oninput="this.setCustomValidity('')"><br> <!--pattern allows any digit entry. minimum value is 10-->
                        ...
                        <textarea name="site" rows="5" cols="30" required placeholder="Size, gardens, driveway, etc"  maxlength="255">
                        </textarea><br> <!--site entry-->

                        <label for="notes">Notes: </label><br> <!--notes textarea label-->
                        <textarea name="notes" rows="5" cols="30" placeholder="E.G. Exceptional condition, beautiful view, landscaped gardens" maxlength="255">
                        ...
                        oninput="this.setCustomValidity('')" maxlength="100"><br> <!--pattern allows any digit, space or comma. minimum value is 1000. custom error values-->
