...
-->
    ...
    <img src="logo.png" alt="Logo" class="brand-side__logo"/> <!--company logo displayed at the top of the sidebar-->
    </div>
    ...
    <nav>
      ...
      <ul class="side-menu">
          ...
          <li class="danger"><a class="side-menu__link" href="https://c2p-auctioneers26.candept.com/Main%20Screens/property.html"><i class="fa-solid fa-house"></i><span>Exit</span></a></li> <!--exit link styled in red as a danger action-->
      </ul>
</nav>
  </aside>